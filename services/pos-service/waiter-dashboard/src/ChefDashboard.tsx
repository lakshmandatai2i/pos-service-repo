      ...
      >
        ...
        <div className="flex flex-col gap-3 flex-grow">
          ...
          <button
            ...
            className={`flex items-center justify-between px-4 py-3.5 rounded-xl font-bold transition-all text-sm cursor-pointer ${activeTab === 'pending'
          ...
          <button
            ...
            className={`flex items-center justify-between px-4 py-3.5 rounded-xl font-bold transition-all text-sm cursor-pointer ${activeTab === 'preparing'
          ...
          <button
            ...
            className={`flex items-center justify-between px-4 py-3.5 rounded-xl font-bold transition-all text-sm cursor-pointer ${activeTab === 'completed'
        ...
        <div className="pt-4 border-t border-white/10 flex items-center justify-between">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full p-1 transition-colors flex items-center cursor-pointer ${isDark ? 'bg-[#f2c35b] justify-end' : 'bg-stone-300 justify-start'
              }`}
          >
      ...
      <main className="flex-grow w-full md:ml-[280px] p-4 sm:p-6 md:p-10 min-h-screen relative overflow-y-auto">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-4 border-b border-white/5">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl font-bold text-xs bg-[#f2c35b]/10 text-[#f2c35b] border border-[#f2c35b]/30 hover:bg-[#f2c35b] hover:text-[#261a00] transition-all flex items-center gap-2 shadow-sm cursor-pointer"
          >
                ...
                <div className="flex justify-between items-start mb-4 pb-3 border-b border-white/10">
                  <div>
                    ...
                    <p className="text-xs text-[#d2c5b1]/70 mt-0.5">
                      {order.section || 'Main Dining'} • Waiter: {order.waiterName || 'John'}
                    </p>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10">
                  {order.status === 'pending' && (
                    <button
                      ...
                      className="w-full py-3 px-4 rounded-xl font-bold text-sm bg-[#f2c35b] text-[#261a00] hover:bg-[#ffe2ab] transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer"
                    >
                  ...
                  {order.status === 'preparing' && (
                    <button
                      ...
                      className="w-full py-3 px-4 rounded-xl font-bold text-sm bg-[#10b981] text-white hover:bg-[#34d399] transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer"
                    >
            ...
            <div className="col-span-full py-16 text-center text-[#d2c5b1]/50 border-2 border-dashed border-white/10 rounded-2xl">
              ...
              {activeTab === 'pending' && (
                <p className="text-xs text-[#d2c5b1]/40 mt-1">
                  Click "+ Simulate New Order" or send an order from Waiter Dashboard.
                </p>
              )}
            </div>
          )}
